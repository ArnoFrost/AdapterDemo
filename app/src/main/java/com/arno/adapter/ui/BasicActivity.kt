...
class BasicActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //创建DataBinding
        mBinding = DataBindingUtil.setContentView(this, R.layout.basic_activity)
...
//        Timber.d("addItem: ")
        ...
        val newList = simpleAdapter.dataList.toMutableList().apply {
            add(0, DataUtils.getRandomUser(false))
        }
...
//            setHasFixedSize(true)
            ...
            //注意相同名称时候引用值作用域区分
            layoutManager = this@BasicActivity.layoutManager
...
//            setItemViewCacheSize(3)
    ...
    companion object {
        const val TAG: String = "BasicActivity"
    }
